      ...
      <nav class="background-transparent background-transparent-hightlight full-width sticky">
        ...
        <div class="top-nav s-12 l-10">
          ...
          <ul class="right chevron">
            ...
            <li><a href="Form Login/register.php">+ Admin</a></li>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-dark">
          <div class="line">        
            <h1 class="text-white margin-top-bottom-40 text-size-60 text-line-height-1"><center>DATA PELANGGAN <br> GO LAUNDRY</h1>
...
<label for="tab1">
<i class="fa fa-code"></i><span class="style3">Semua Data Pelanggan</span> &nbsp;&nbsp;&nbsp;&nbsp;</label>

<input id="tab2" name="tabs" type="radio" />
<label for="tab2">
<i class="fa fa-pencil-square-o"></i><span class="style3">Cari Data Pelanggan</span> &nbsp;&nbsp;&nbsp;&nbsp;</label> 
...
<div>
<iframe src="data.php" width="100%" height="1900" scrolling="no" frameborder="0" name="isi"></iframe>
</div></section>
...
<div id="">		 	
   <iframe src="cari.php" width="100%" height="500" scrolling="no" frameborder="0" name="isi"></iframe>
</div></section>
